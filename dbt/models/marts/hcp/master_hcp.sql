...
select
    ...
    "gender" as "Gender",
    "X_informatica_type" as "HCP_Type",
    "X_hcp_status" as "Status",
    "X_iqvia_title" as "Title",
    "prefixName" as "Prefix_Name",
    "X_hcp_address" as "Address",
    "Phone" as "Phone",
    "Qualification" as "Qualification",
    "X_informatica_dea" as "DEA_Number",
    ...
    "X_informatica_language" as "Language",
    "X_origin_university_name" as "Origin_University_Name",
    "X_origin_university_code" as "Origin_University_Code",
    "X_informatica_tendency_code" as "Tendency_Code",
    "X_informatica_tendency_rank" as "Tendency_Rank"
from {{ ref('mdm_hcp') }}
