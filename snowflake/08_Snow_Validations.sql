...
SELECT 
    ...
    13 AS total_tables
FROM (
    SELECT COUNT(*) AS row_count FROM HMDM_DEV.STAGING.HCP_ADDRESS WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_ALTERNATE_NAME WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_EDUCATION WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_EMAIL WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_HCO_AFFILIATION WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_IDENTIFICATION WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_LANGUAGE WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_LICENSE WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_NAME WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_ORIGIN_UNIVERSITY WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_PHONE WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_SPECIALTY WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_TAX WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCP_TENDENCIES WHERE COUNT(*) > 0
) hcp
UNION ALL
SELECT 
    'HCO (9 tables)',
    ...
    9
FROM (
    SELECT COUNT(*) AS row_count FROM HMDM_DEV.STAGING.HCO_ADDRESS WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_ALTERNATE_NAME WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_EMAIL WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_HIERARCHY WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_IDENTIFICATION WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_NAME WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_PHONE WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_SPECIALTY WHERE COUNT(*) > 0
    UNION ALL SELECT COUNT(*) FROM HMDM_DEV.STAGING.HCO_TAX WHERE COUNT(*) > 0
) hco
...
--     X_infa360_Specialty, etc. matching the Informatica MDM schema
...
--     Example: sourcePKey, firstName, lastName, X_infa360_Specialty, etc.
SELECT 
    TABLE_NAME,
    COLUMN_NAME,
    DATA_TYPE,
...
--     (dbt run logs showed these were created in STAGING_MDM, not HMDM_DEV.MDM)
